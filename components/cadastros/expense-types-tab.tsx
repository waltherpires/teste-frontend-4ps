...
export function ExpenseTypesTab() {
  ...
  const handleAddType = () => {
    ...
    if (editingTypeId) {
      updateExpenseType(editingTypeId, typeName);
    } else {
  ...
  const handleAddSubcategory = () => {
    ...
    if (editingSubcategoryId) {
      ...
      addExpenseSubcategory(selectedTypeId, newSubcategory);
    }
  ...
  const handleDeleteSubcategory = (typeId: string, subId: string) => {
    deleteExpenseSubcategory(typeId, subId);
  };
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Gerencie categorias e subcategorias de gastos. Elas serão usadas
          ...
          <Dialog open={open} onOpenChange={handleOpenChange}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  {mode === "type"
                    ? "Defina o nome da categoria de gasto"
